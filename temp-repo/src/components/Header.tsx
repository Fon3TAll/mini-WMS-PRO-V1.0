      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex flex-col justify-center">
            <div className="flex items-center gap-2 font-exception-header">
                <span className="font-black text-[#212c46] text-[25px] tracking-wide uppercase leading-none">LAW LIBRARY</span>
                <span className="font-bold text-[#4d87a8] text-[25px] tracking-wide uppercase leading-none">HUB</span>
                <span className="bg-[#b58c4f] hidden sm:block text-white text-[10px] font-black uppercase px-2 py-0.5 rounded ml-2 tracking-wider">LEGAL PRECEDENT</span>
            </div>
            <div className="flex items-center gap-3 mt-0.5 font-exception-header">
                <div className="w-10 h-[2px] bg-[#b58c4f]"></div>
                <span className="text-[10px] font-bold text-[#7a8b95] uppercase tracking-[0.2em] leading-none">INTEGRATED LEGAL AND STATUTORY MANAGEMENT</span>
            </div>
        </div>
      </div>
