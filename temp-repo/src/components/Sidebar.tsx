    ...
    >
      ...
      <div className="flex h-24 items-center justify-start px-6 shrink-0">
        <div className="flex items-center gap-1.5 pr-2">
          <div className="relative flex h-12 w-12 items-center justify-center transition-transform duration-500 hover:scale-105 drop-shadow-[0_4px_12px_rgba(0,0,0,0.4)] shrink-0">
            <Shield size={46} className="text-[#d4af37] fill-[#d4af37]/10" strokeWidth={1} />
            <Scale size={22} className="absolute text-[#d4af37] mt-[-2px]" strokeWidth={1.5} />
          </div>
          {!isCollapsed && (
            <div className="flex flex-col">
              <div className="flex items-center gap-[4px] text-[24px] font-black tracking-tighter font-exception-system transform scale-x-105 origin-left leading-none" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.5)' }}>
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#b58c4f] to-[#f3e5ab]">LAW</span>
              </div>
              <div className="flex items-center mt-2 group" style={{ fontFamily: "'Inter', sans-serif" }}>
                ...
                <span className="text-[10px] font-bold text-[#7a8b95] group-hover:text-[#b58c4f] transition-colors tracking-[0.3em] uppercase leading-none drop-shadow-md">
                  SMART LIBRARY
                </span>
              </div>
            </div>
