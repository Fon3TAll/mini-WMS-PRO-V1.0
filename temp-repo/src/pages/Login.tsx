  ...
  return (
    <div className="relative flex min-h-screen w-full font-mono bg-slate-900 overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('https://images.stockcake.com/public/f/5/8/f585a0a9-fcef-41be-aa59-8950aac5b549/justice-scales-office-stockcake.jpg')`
        }}
      />
        ...
        <div className="hidden w-1/2 flex-col justify-between bg-[#111f42]/40 p-12 lg:flex backdrop-blur-sm border-r border-white/10">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4 text-white mb-16 cursor-pointer group">
              <div className="relative flex h-12 w-12 items-center justify-center transition-transform duration-500 group-hover:scale-105 drop-shadow-[0_4px_12px_rgba(0,0,0,0.4)]">
                <Shield size={46} className="text-[#e2e8f0] fill-white/5" strokeWidth={1} />
                <Scale size={22} className="absolute text-[#e2e8f0] mt-[-2px]" strokeWidth={1.5} />
              </div>
            ...
            >
              ...
              <h2 className="text-[26px] font-bold text-white mb-8 tracking-wide drop-shadow-md">
                Intelligent Legal Management Hub
              </h2>
              <p className="max-w-md text-[15px] leading-relaxed text-white/80 font-medium">
                Streamline your legal workflows, optimize<br />
                case document security, and take full control of your<br />
                statutory compliance with our advanced intelligence platform.<br />
              </p>
          ...
          <div className="flex w-full items-end justify-between mt-auto">
            ...
            <div className="flex items-center gap-4 rounded-3xl border border-white/20 bg-[#2a2d45]/40 backdrop-blur-md p-4 shadow-2xl">
              ...
              <div className="flex flex-col pr-2">
                <span className="text-[14px] font-bold text-white tracking-wide">SMART LAW Developer</span>
