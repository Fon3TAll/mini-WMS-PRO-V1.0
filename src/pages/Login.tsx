...
import { Lock, User as UserIcon, Users, Loader2, Package, ArrowRight, Phone, Mail, Eye, EyeOff, Scale, Shield, Warehouse } from 'lucide-react';
  ...
  return (
    <div className="relative flex min-h-screen w-full font-mono bg-slate-900 overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('https://www.lightguidesys.com/wp-content/uploads/2024/06/smart-warehouse-technology.png')`
        }}
      />
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4 text-white mb-16 cursor-pointer group">
              <div className="relative flex h-14 w-14 items-center justify-center transition-transform duration-500 group-hover:scale-105 drop-shadow-[0_4px_12px_rgba(0,0,0,0.4)]">
                <svg viewBox="12 22 78 70" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
                  {/* Building Base */}
            ...
            >
              ...
              <h2 className="text-[26px] font-bold text-white mb-8 tracking-wide drop-shadow-md font-exception-header">
                Intelligent Warehouse Management System
              </h2>
              <p className="max-w-md text-[15px] leading-relaxed text-white/80 font-medium font-ui">
                Optimize your warehouse operations, reduce costs,<br />
                and gain full control with an intelligent,<br />
                end-to-end management platform.<br />
              </p>
          ...
          <div className="flex w-full items-end justify-between mt-auto">
            ...
            <div className="flex items-center gap-4 rounded-3xl border border-white/20 bg-[#2a2d45]/40 backdrop-blur-md p-4 shadow-2xl">
              ...
              <div className="flex flex-col pr-2">
                <span className="text-[14px] font-bold text-white tracking-wide">SMART WMS Developer</span>
