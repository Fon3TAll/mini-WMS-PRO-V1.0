    ...
    <>
      ...
      <div className={`fixed inset-y-0 right-0 z-[200] w-full md:w-[500px] bg-white shadow-2xl transform transition-transform duration-500 ease-in-out flex flex-col border-l-2 border-[#b7a159] ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex justify-between items-center p-5 px-6 border-b-2 border-[#b7a159] bg-[#212c46] text-white shrink-0">
          <div>
            <h3 className="font-black flex items-center gap-3 uppercase tracking-widest text-lg"><Icons.BookOpen size={22} className="text-[#b7a159]"/> INFLOW GUIDE</h3>
            <p className="text-[12px] font-bold text-[#d7d7d7] uppercase tracking-widest mt-1.5">Raw Material Flow Management</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8 text-[#414757] text-[12px] leading-relaxed custom-scrollbar bg-white">
          <section className="animate-fadeIn">
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Icons.TrendingDown size={18} className="text-[#b58c4f]"/> 1. Raw Material Inbound Processing
            </h4>
            <p className="text-[12px] mb-3">ระบบออกแบบมาให้จัดการและตรวจสอบสถานะการรับวัตถุดิบ <b>(Raw Material Inbound)</b> และพัสดุในคลังสินค้าแบบเรียลไทม์:</p>
            <ul className="list-none pl-0 space-y-3">
                ...
                <li className="flex items-start gap-2 bg-[#b58c4f]/10 p-3 rounded-xl border border-[#b58c4f]/30">
                  ...
                  <div><strong className="text-[#b58c4f]">Pending Check:</strong> รายการรอดำเนินการ ตรวจสอบเอกสาร และชั่งน้ำหนัก ตลอดจนตรวจสอบมาตรฐานสิ่งปนเปื้อน</div>
                </li>
                <li className="flex items-start gap-2 bg-[#932c2e]/10 p-3 rounded-xl border border-[#932c2e]/30">
                  ...
                  <div><strong className="text-[#932c2e]">Quarantine / Blocked:</strong> รายการสินค้าชำรุด ไม่ผ่านเกณฑ์มาตรฐานความชื้นหรือกายภาพ ถูกคัดแยกไปที่คลังกักกัน</div>
                </li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-2 text-[12px]">
                <li><strong className="text-[#4d87a8]">Document Flow:</strong> แสดงผลในรูปแบบตารางเดินเอกสาร ตรวจประวัติ รับเข้า ดึงเลขที่ GR (Good Receipt), ตรวจสอบชื่อผู้ตรวจสอบรับสินค้า</li>
                <li><strong className="text-[#d96245]">Inventory Matrix:</strong> แสดงผลเชิงพื้นที่ในรูปแบบ Grid Bento รวบรวมข้อมูลสถานะการใช้ชั้นวาง (Storage slots), รหัสนายคิว (Batch Lot), และระดับความจุการจัดเก็บเพื่อป้องกันการอัดแน่นของคลังวัตถุดิบ</li>
            </ul>
          </section>
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            ...
            <p className="text-[12px]">พนักงานที่มีสิทธิ์ที่เกี่ยวข้องเท่านั้นจะสามารถเปิดและปรับเปลี่ยนสถานะเอกสาร ดึงพารามิเตอร์ และสั่งพิมพ์เอกสารสติ๊กเกอร์ติดบน Bulk Cargo หรือพาเลท (Pallet tag serialization)</p>
          </section>
        </div>
...
export default function RMInflowReport() {
    ...
    const [records, setRecords] = useState<any[]>([
        { id: 'GR-202311-001', vendor: 'Alpha Chemicals', material: 'RM-01: Resins', date: '2023-11-01', qty: 500, unit: 'kg', status: 'Completed', inspector: 'Suda K.', slot: 'SLOT-A4', batch: 'B23-RE01', spec: 'Moisture <0.5%' },
        { id: 'GR-202311-002', vendor: 'Global Supply Co', material: 'RM-14: Colorants', date: '2023-11-02', qty: 200, unit: 'L', status: 'Pending', inspector: '-', slot: 'SLOT-B2', batch: 'B23-CO14', spec: 'Viscosity standard' },
        { id: 'GR-202311-003', vendor: 'Thai Metalic Plus', material: 'RM-22: Steel Sheets', date: '2023-11-02', qty: 1500, unit: 'pcs', status: 'Completed', inspector: 'Suda K.', slot: 'SLOT-C1', batch: 'B23-ST22', spec: 'Gauge 1.5mm' },
        { id: 'GR-202311-004', vendor: 'NextGen Polymers', material: 'RM-05: Solvents', date: '2023-11-03', qty: 850, unit: 'L', status: 'Quarantine', inspector: 'Manee J.', slot: 'SLOT-Q9', batch: 'B23-SO05', spec: 'Flashpoint rejected' },
        { id: 'GR-202311-005', vendor: 'Alpha Chemicals', material: 'RM-01: Resins', date: '2023-11-04', qty: 900, unit: 'kg', status: 'Completed', inspector: 'Wichai T.', slot: 'SLOT-A5', batch: 'B23-RE02', spec: 'Moisture <0.5%' },
    ]);
    ...
    return (
        <div className="flex flex-1 w-full flex-col animate-fadeIn bg-transparent space-y-4">
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <h3 className="font-black text-[#212c46] uppercase tracking-tighter leading-none font-exception-header" style={{ fontSize: '24px' }}>
                            RAW MATERIAL <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3f809e] to-[#b58c4f]">INFLOW</span> REPORT
                        </h3>
                        <p className="text-[11px] font-bold text-[#4d5a44] uppercase tracking-[0.2em] mt-0.5 opacity-80 leading-none font-sans">
                            INCOMING GOODS & MATERIALS MONITORING
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="bg-white rounded-3xl shadow-lg border border-[#eaeaec] overflow-hidden flex flex-col animate-fadeIn mt-8">
                        ...
                        <div className="px-8 py-4 border-b border-[#eaeaec] bg-[#f8f9fa] flex flex-col md:flex-row justify-between items-center gap-4 shrink-0">
                            ...
                            <div className="flex items-center gap-3 w-full md:w-auto">
                                <div className="relative flex-1 md:w-80">
                                    ...
                                    <input type="text" value={search} onChange={e => setSearch(e.target.value)} placeholder="Search document, vendor..." className="w-full pl-12 pr-6 py-2.5 text-[12px] border border-[#eaeaec] rounded-full font-bold outline-none focus:border-[#b7a159] bg-white shadow-sm text-[#212c46]" />
                                </div>
                                <button onClick={() => {
                                    const csvContent = "data:text/csv;charset=utf-8," 
                                        + ["Document ID,Date,Vendor,Material,Quantity,Status,Inspector,Slot,Batch"].join(",") + "\n"
                                        + records.map(r => `"${r.id}","${r.date}","${r.vendor}","${r.material}",${r.qty},"${r.status}","${r.inspector}","${r.slot}","${r.batch}"`).join("\n");
                                    const encodedUri = encodeURI(csvContent);
                                    const link = document.createElement("a");
                                    link.setAttribute("href", encodedUri);
                                    link.setAttribute("download", `RM_Inflow_Report_${new Date().toISOString().slice(0,10)}.csv`);
                        ...
                        <div className="overflow-auto custom-scrollbar bg-[#f8f9fa]">
                            {viewMode === 'doc_flow' ? (
                                <table className="w-full text-left font-sans border-collapse">
                                    <thead className="bg-[#222b38] text-white">
                                        <tr className="border-b-2 border-[#b58c4f]">
                                            <th className="py-4 px-6 font-black uppercase tracking-widest text-[11px] whitespace-nowrap">Document ID</th>
                                            <th className="py-4 px-4 font-black uppercase tracking-widest text-[11px] whitespace-nowrap">Receipt Date</th>
                                            <th className="py-4 px-4 font-black uppercase tracking-widest text-[11px] whitespace-nowrap">Vendor</th>
                                            <th className="py-4 px-6 font-black uppercase tracking-widest text-[11px] whitespace-nowrap">Material</th>
                                            <th className="py-4 px-4 font-black uppercase tracking-widest text-[11px] whitespace-nowrap text-right">Quantity</th>
                                            <th className="py-4 px-4 font-black uppercase tracking-widest text-[11px] whitespace-nowrap text-center">Status</th>
                                            <th className="py-4 px-4 font-black uppercase tracking-widest text-[11px] whitespace-nowrap text-center">Inspector</th>
                                    ...
                                    <tbody className="bg-white divide-y divide-[#eaeaec]">
                                        {filteredRecords.length > 0 ? filteredRecords.map((item, index) => (
                                            <tr key={item.id} className="hover:bg-[#f8f9fa] transition-colors group">
                                                ...
                                                <td className="py-3 px-4 text-[12px] text-[#7a8b95] font-bold">
                                                    {item.date}
                                                </td>
                                                <td className="py-3 px-4 text-[12px] text-[#212c46] font-bold">
                                                    {item.vendor}
                                                </td>
                                                <td className="py-3 px-6 text-[12px] text-[#4d87a8] font-bold">
                                                    {item.material}
                                                </td>
                                                <td className="py-3 px-4 text-[12px] text-[#212c46] font-black text-right">
                                                    {item.qty.toLocaleString()} <span className="text-[#7a8b95] font-bold text-[10px]">{item.unit}</span>
                                                </td>
                                                <td className="py-3 px-4 text-center">
                                                    {item.status === 'Completed' ? (
                                                        <span className="inline-flex items-center justify-center bg-[#657f4d]/10 text-[#657f4d] px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border border-[#657f4d]/20"><Icons.Check size={10} className="mr-1"/> {item.status}</span>
                                                    ) : item.status === 'Quarantine' ? (
                                                        <span className="inline-flex items-center justify-center bg-[#932c2e]/10 text-[#932c2e] px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border border-[#932c2e]/20"><Icons.AlertTriangle size={10} className="mr-1"/> {item.status}</span>
                                                    ) : (
                                                        <span className="inline-flex items-center justify-center bg-[#b58c4f]/10 text-[#b58c4f] px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border border-[#b58c4f]/20"><Icons.Clock size={10} className="mr-1"/> {item.status}</span>
                                                    )}
                                                </td>
                                                <td className="py-3 px-4 text-center text-[12px] text-[#7a8b95] font-bold">
                                                    {item.inspector}
                                                </td>
                                                <td className="py-3 px-6">
                                                    <div className="flex items-center justify-center gap-1">
                                                        <button onClick={() => handleView(item)} className="w-8 h-8 rounded-lg flex items-center justify-center text-[#4d87a8] hover:bg-[#4d87a8]/15 transition-all text-sm font-bold" title="View & Edit Document">
                                                            <Icons.Edit size={15}/>
                                                        </button>
                                                        <button onClick={() => handlePrint(item)} className="w-8 h-8 rounded-lg flex items-center justify-center text-[#7a8b95] hover:bg-[#7a8b95]/15 transition-all text-sm" title="Print Tag">
                                            ...
                                            <tr>
                                                <td colSpan={8} className="py-12 text-center text-[#7a8b95] font-bold text-[12px]">No material flow matched search query.</td>
                                            </tr>
                                        )}
                                    </tbody>
                                </table>
                                ...
                                <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {filteredRecords.length > 0 ? filteredRecords.map((item, index) => {
                                        const capacityPercent = Math.min(Math.round((item.qty / 1500) * 105), 100);
                                        return (
                                            <div key={item.id} className="bg-white rounded-2xl border border-[#eaeaec] p-5 shadow-sm hover:border-[#b7a159] transition-all duration-300 relative overflow-hidden group flex flex-col justify-between">
                                                ...
                                                <div className="space-y-1 mb-4 flex-1">
                                                    ...
                                                    <p className="text-[11px] text-[#7a8b95] font-medium font-sans">Vendor: <span className="font-bold text-[#414757]">{item.vendor}</span></p>
                                        ...
                                        <div className="col-span-full py-16 text-center text-[#7a8b95] font-bold text-[12px]">No raw material batches matched your search criteria.</div>
                                    )}
                                </div>
                            )}
                        </div>
                        ...
                        <div className="px-8 py-3 bg-[#f8f9fa] border-t border-t-[#eaeaec] flex flex-col md:flex-row justify-between items-center gap-4 shrink-0 font-sans">
                            <div className="text-[11px] font-black text-[#7a8b95] uppercase tracking-widest">
                                Showing {filteredRecords.length} of {records.length} registered raw material flows
                            </div>
                            <div className="text-[10px] font-bold text-[#7a8b95] bg-white px-4 py-2 border border-[#eaeaec] rounded-xl flex items-center gap-2 shadow-inner">
                                <span className="w-2 h-2 rounded-full bg-[#657f4d] animate-pulse"></span> SYSTEM OK - REALTIME CLOUD SYNCED (LOCALSTORAGE PERSISTED)
                            </div>
                        </div>
            ...
            {/* SPACER FOR MARGIN OFFSET (mt-8) BEFORE FOOTER TO MATCH SPEC */}
            ...
            >
                <div className="p-6 space-y-5 font-sans bg-white text-[#414757]">
                    <div className="grid grid-cols-2 gap-4 bg-[#f8f9fa] p-4 rounded-xl border border-[#eaeaec]">
                        <div>
                            <span className="text-[10px] font-bold text-[#7a8b95] uppercase tracking-wider block">Raw Material:</span>
                            <span className="text-[12px] font-black text-[#212c46] block">{selectedRecord?.material}</span>
                        </div>
                        <div>
                            <span className="text-[10px] font-bold text-[#7a8b95] uppercase tracking-wider block">Vendor Group:</span>
            ...
            >
                <div className="p-6 bg-white font-sans text-[#414757]">
                    <div id="material-print-label" className="border-4 border-dashed border-[#212c46] p-5 rounded-2xl space-y-4 max-w-[400px] mx-auto bg-white shadow-inner relative overflow-hidden text-black font-mono">
                        ...
                        {/* Tag Header */}
                        <div>
                            <span className="text-[12px] font-black border-b border-black pb-1 uppercase tracking-widest text-[#212c46] block w-fit">INFLOW LABEL SERIAL_TAG</span>
                            <h2 className="text-[18px] font-black tracking-tight uppercase text-black mt-2 leading-tight">{selectedRecord?.material}</h2>
                            <p className="text-[10px] text-[#414757] font-bold uppercase mt-1">Vendor: {selectedRecord?.vendor}</p>
                        </div>
