      ...
      <div className={`fixed inset-y-0 right-0 z-[200] w-full md:w-[500px] bg-white shadow-2xl transform transition-transform duration-500 ease-in-out flex flex-col border-l-2 border-[#b7a159] ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8 text-[#414757] text-[12px] leading-relaxed custom-scrollbar bg-white">
          ...
          <section className="animate-fadeIn" style={{ animationDelay: '0.3s' }}>
            <h4 className="text-[14px] font-black text-[#212c46] mb-3 uppercase flex items-center gap-2 border-b-2 border-[#d7d7d7] pb-2 font-mono">
              <Icons.Move size={18} className="text-[#b7a159]"/> 4. Draggable Workspace (ลากย้ายอิสระ)
            </h4>
            <p className="text-[12px]">หน้าต่างกำหนดสิทธิ์บุคคล (Edit Staff) สามารถ <b>ลากสลับตำแหน่งได้ (Drag & Drop)</b> เพื่ออ้างอิงรายชื่อและข้อมูลในตารางกับผู้ใช้งานท่านอื่นๆ ได้อย่างสะดวกรวดเร็ว</p>
          </section>
        </div>
                            ...
                            <table className="w-full text-left font-sans border-collapse">
                                <thead className="bg-[#212c46] text-white">
                                    <tr className="border-b-2 border-[#b7a159]">
                                        <th className="py-4 px-6 font-black uppercase tracking-widest text-[12px] whitespace-nowrap">ข้อมูลบุคคลากร</th>
                                        <th className="py-4 px-6 font-black uppercase tracking-widest text-[12px] whitespace-nowrap">ตำแหน่งหน้าที่ความรับผิดชอบ</th>
                                        <th className="py-4 px-6 font-black uppercase tracking-widest text-[12px] whitespace-nowrap">อีเมลติดต่อ</th>
                                        <th className="py-4 px-6 font-black uppercase tracking-widest text-[12px] text-center">ประเภทสิทธิ์อนุญาต</th>
                            ...
                            <table className="w-full text-left font-sans border-collapse min-w-[900px]">
                                <thead className="bg-[#091d38] text-white">
                                    <tr className="border-b-[3px] border-[#b7a159]">
                                        <th className="py-4 px-6 font-black uppercase tracking-widest text-[11px] border-r border-[#ffffff20] w-72">โมดูลการใช้งาน / โมดูลย่อย</th>
                                        {currentData.map(user => (
